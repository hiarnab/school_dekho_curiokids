...
<form class="card-body">
    ...
    <fieldset class="fieldset">
        <div class="">
            <label for="name" name="name" class="block text-sm font-medium mb-2 dark:text-white">Full Name</label>
        ...
        <div class="">
            <label for="city" class="block text-sm font-medium mb-2 dark:text-white">City</label>
            <div class="relative">
